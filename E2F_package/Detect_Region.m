function [R,C,scale,minPoi,Mc,na,hypo,hypo_out]=Detect_Region(name)
    if strcmp(name, 'Toc2me')
       hypo = readtable('/home/me/Documents/H3D/hough-3d-lines-master/OriData/Magcatalog/toc2me/ToC2ME.txt');
    ...
    elseif strcmp(name, 'Tibetan')
       hypo = readtable('/home/me/Documents/H3D/hough-3d-lines-master/OriData/Magcatalog/Tibetan/Tibetan.txt');
    end
    ...
    elseif 0.1<max(table2array(hypo_out(:,3)))-min(table2array(hypo_out(:,3)))&&...
        ...
        R=[0.1,0.5,1];C=[5,8,10,12,15,20,25,30;
                                       1,2,3,4,9,10,11,12;
