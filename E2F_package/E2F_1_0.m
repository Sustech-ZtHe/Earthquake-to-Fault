...
scatter3(table2array(hypo_out(:,3)),table2array(hypo_out(:,2)),table2array(hypo_out(:,4)), ...
                power(exp(table2array(hypo_out(:,11))),1/5),'filled', ...
                'MarkerEdgeColor',[153/255 0 0],'MarkerFaceColor',[255/255 51/255 51/255]);
hold on;box on
xlim([min(min(table2array(hypo_out(:,3)))) max(max(table2array(hypo_out(:,3))))]);
