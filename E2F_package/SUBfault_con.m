function Rectangle_points=SUBfault_con(Optimal_C,f_sort_E2F,line_nums_2,hypotout,FaultpaRameters,Mc,minPoi,la0,lo0,colortemplate)
n=1;FE_km=[];
nw=1;RabY=[];
...
if isempty(FE_km)
    ...
    % Optimal_C
    Rectangle_points=[];
    l=find(FaultpaRameters(:,29)==Optimal_C);
    ...
    xlabel('Easting(km)');ylabel('Northing(km)');zlabel('Depth(km)'); axis equal;
