...
% Last Modified by GUIDE v2.5 21-Dec-2024 14:25:53
...
ab_output=readtable([num2str(currentPath),'/hough-3d-lines-master/ab.output.txt']);
...
% --- Executes on button press in un_MODE2.
function un_MODE2_Callback(hObject, eventdata, handles)
global fai_MODE
if (get(hObject,'Value') == get (hObject,'Max'))
    fai_MODE=2;
else
