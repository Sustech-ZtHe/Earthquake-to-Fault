...
e2f_package=f"{e2f_road}/E2F_package"
savedata_package=f"{e2f_road}/SaveData"
...
shutil.copytree(e2f_package, os.path.join(h3d_road,os.path.basename(e2f_package)))
shutil.copytree(savedata_package, os.path.join(h3d_road,os.path.basename(e2f_package)))
